...
export const SCHEMA_DATA = {
  ...
  'core/_annotation_list.schema.json': coreAnnotationListSchemaJson,
  'core/annotation_state.schema.json': coreAnnotationStateSchemaJson,
  'core/annotation_visual.schema.json': coreAnnotationVisualSchemaJson,
  ...
  'math/vector3x1.schema.json': mathVector3x1SchemaJson,
  'primitives/circle.schema.json': primitivesCircleSchemaJson,
  'primitives/image.schema.json': primitivesImageSchemaJson,
  'primitives/point.schema.json': primitivesPointSchemaJson,
  'primitives/polygon.schema.json': primitivesPolygonSchemaJson,
  'primitives/polyline.schema.json': primitivesPolylineSchemaJson,
