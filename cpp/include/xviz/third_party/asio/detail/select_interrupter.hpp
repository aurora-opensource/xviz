...
#include "xviz/third_party/asio/detail/socket_select_interrupter.hpp"
#elif defined(ASIO_HAS_EVENTFD)
#include "xviz/third_party/asio/detail/eventfd_select_interrupter.hpp"
#else
#include "xviz/third_party/asio/detail/pipe_select_interrupter.hpp"
#endif
