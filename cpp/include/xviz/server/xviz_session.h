...
class XVIZBaseSession {
 public:
  XVIZBaseSession(
      std::shared_ptr<websocketpp::connection<websocketpp::config::asio>>
          conn_ptr);
  // void SetMainHandler(const std::function<void(websocketpp::connection_hdl,
  // std::shared_ptr<asio::steady_timer>,
  //   std::shared_ptr<void>)>& main_function);
  // void SetMainHandler(std::function<void(websocketpp::connection_hdl,
  // std::shared_ptr<asio::steady_timer>,
  //   std::shared_ptr<void>)>&& main_function);
 ...
 protected:
  std::shared_ptr<websocketpp::connection<websocketpp::config::asio>> conn_ptr_{
      nullptr};
