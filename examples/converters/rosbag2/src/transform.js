...
import {Rosbag2Converter} from './converters';
...
module.exports = async function main(args) {
  ...
  const converter = new Rosbag2Converter(inputDir, outputDir, {
    cameraSources,
    disabledStreams,
    fakeStreams,
    imageMaxWidth,
  ...
  console.log(`Converting Rosbag2 data at ${inputDir}`); // eslint-disable-line
