...
test('setXvizConfig', t => {
  ...
  t.notOk(getXvizConfig()._PRIMITIVE_SETTINGS.line2d, 'XVIZ primitive settings is v2');

  setXvizConfig({version: 1});
  t.ok(getXvizConfig()._PRIMITIVE_SETTINGS.line2d, 'XVIZ primitive settings is v1');
